...
public class CheckingAction implements Action{
    ...
    public ArrayList<BinaryOperation> getProblems() {
        return problems;
    }
    public void setProblems(ArrayList<BinaryOperation> problems) {
        this.problems = problems;
    }
    public ArrayList<Integer> getAnsw() {
        return answ;
    }
    public void setAnsw(ArrayList<Integer> answ) {
        this.answ = answ;
    }
